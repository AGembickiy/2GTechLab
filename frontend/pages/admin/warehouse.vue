  ...
  <div class="space-y-6">
    ...
    <div class="rounded-2xl border border-slate-800/60 bg-slate-900/40 p-6">
      <div class="mb-4 flex items-center justify-between gap-4">
        ...
        <UButton v-if="editingMaterialId" color="gray" variant="soft" size="sm" @click="resetForm">
          Отменить
        </UButton>
      </div>
      ...
      <form class="grid grid-cols-1 gap-3 md:grid-cols-2 xl:grid-cols-4" @submit.prevent="saveMaterial">
        ...
        <div class="flex items-center gap-2 md:col-span-2 xl:col-span-4">
          <UButton type="submit" :loading="isSaving" color="primary">
            ...
            >
              ...
              <td class="px-3 py-2">
                <div class="flex justify-end gap-2">
                  <UButton size="xs" color="gray" variant="soft" @click="startEdit(material)">
                    Изменить
                  </UButton>
                  <UButton
                    size="xs"
