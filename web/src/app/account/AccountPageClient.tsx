      ...
      <div className="w-full max-w-md mx-auto text-center">
          ...
          {(["email", "phone", "telegram"] as const).map((m) => (
            <button
              ...
              className={`cta-btn text-sm py-1.5 ${
                method === m
                  ? "cta-btn--blue"
                  : "bg-[rgba(51,65,85,0.6)] text-[#94a3b8] hover:text-[#e5e7eb]"
              }`}
            >
        ...
        {method === "telegram" ? (
          ...
          <form onSubmit={handleSubmit} className="feature-tile space-y-4 text-left">
            {method === "email" ? (
              <div>
                <label
                  ...
                  className="feature-tile__subtext block mb-1 font-medium text-[#cbd5e1]"
                >
                  Email
                </label>
                <input
            ...
            <button type="submit" disabled={loading} className="cta-btn cta-btn--blue w-full">
